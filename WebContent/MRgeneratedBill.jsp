...
<div class="main">
		...
		ResultSet rs=null;
		String select_mahajanOil="select * from mahajan_dal where sdate=? and mid=? ";
		String select_OilmahajanBilling="select * from dalmahajan_billing where sdate=? and mid=?";
