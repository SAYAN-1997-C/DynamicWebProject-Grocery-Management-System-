	...
	<div class="main">
		<div class="box" >
				...
				<%	
					...
					ResultSet rs=null;
					String select_custRice="select * from cust_dal where cdate=? and cid=? ";
					String select_custBill="select * from dalcust_bill where cdate=? and cid=?";
					String select_Cname="select cname from dalcust_main where cid=?";
			...
			<div class="actionBtn">
			<div>
						<form action="CRCustGeneratedBill.jsp" method="post">
							<input type="hidden" name="cdate" value="<%=cdate%>">
							<input type="hidden" name="cid" value="<%=cid%>">
							<input class="print_btn" type="submit" value="PRINT">
						</form>
					</div>
				<a href="DalCustDelInputForm.jsp"><input class="mahajan_button" type="button" value="DELETE"></a>	
			</div>
			<a href="DalWelcomeDueCust.jsp" class="gobackHome">click Home</a>
		</div>
	</div>
</body>
</html>