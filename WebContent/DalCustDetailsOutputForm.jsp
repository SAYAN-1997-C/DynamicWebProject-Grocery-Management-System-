		...
		<div class="box" >
			...
			<table>
				...
				<%	
					...
					ResultSet rs=null;
					String select_custMain="select * from dalcust_main where cid=?";
					String select_custBill="select * from dalcust_bill where cid=?";
			...
			<a href="DalWelcomeDueCust.jsp" class="gobackHome"> Go To Home</a>
