...
/**
 * Servlet implementation class DalCustDelServe
 */
public class DalCustDelServe extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String select_bill="select total_bill,total_due from dalcust_bill where cdate=? and cid=?";
		String x="0";
