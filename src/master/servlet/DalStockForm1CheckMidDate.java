...
/**
 * Servlet implementation class DalStockForm1CheckMidDate
 */
public class DalStockForm1CheckMidDate extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(flag==1)
		{
			...
			RequestDispatcher rd=request.getRequestDispatcher("DalStockForm1.jsp");
			rd.forward(request, response);
		}
	}
